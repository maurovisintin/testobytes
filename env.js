 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.testexpo-owner.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.testobytes'; // ios bundle id
const PACKAGE = 'com.testobytes'; // android package name
const NAME = 'testobytes'; // app name
const EXPO_ACCOUNT_OWNER = 'sexykodo'; // expo account owner
const EAS_PROJECT_ID = 'a4576851-6e47-4001-b7f0-69031ddcf5ad'; // eas project id
const SCHEME = 'testobytes'; // app scheme
